...
Примеры использования:
  ...
  python sdui_refs_manager.py /Users/username/Documents/FMS_GIT/SDUI

  # Конвертировать обратно в относительные пути
  python sdui_refs_manager.py /Users/username/Documents/FMS_GIT/SDUI --relative

  # Только показать что будет изменено (dry run)
  python sdui_refs_manager.py /Users/username/Documents/FMS_GIT/SDUI --dry-run

  # Обработать только определенные файлы
  python sdui_refs_manager.py /Users/username/Documents/FMS_GIT/SDUI --pattern "components/*/v1/*.json"

  # Включить обработку samples
  python sdui_refs_manager.py /Users/username/Documents/FMS_GIT/SDUI --include-samples
        """
    )
