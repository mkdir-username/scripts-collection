...
def render_template(template_path, data_path, jj_full_path, map_path, full_path, 
    ...
    try:
        ...
        # Add modules/ subdirectory for relative imports from within modules
        modules_dir = os.path.join(template_dir, 'modules')
        search_paths = [template_dir, tmp_dir]
        if os.path.isdir(modules_dir):
            search_paths.insert(1, modules_dir)
        ...
        try:
            ...
            # HARD FAIL — no placeholder, propagate error
