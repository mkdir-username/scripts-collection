#!/usr/bin/env python3
"""
SDUI Schema Final Resolver - с внутренними координатами
Вместо внешних ссылок используются пути к первому вхождению в том же документе
"""
...
class SDUIFinalResolver:
    ...
    def create_internal_stub(self, ref: str, name: str, first_path: str, reason: str = "duplicate") -> Dict:
        ...
        return {
            ...
            "_first_occurrence_path": first_path,  # ← КЛЮЧЕВОЕ: путь внутри документа!
            "_reason": reason,
            "type": "object",
...
def main():
    parser = argparse.ArgumentParser(
        description="SDUI Final Resolver - with internal navigation coordinates"
    )
