...
def validate_contract():
    # Load the metaschema
    metaschema_path = Path("/Users/username/Documents/front-middle-schema/metaschema/schema/strict_unversioned.json")
    # Get contract path from command line argument or use default
    import sys
    if len(sys.argv) > 1:
        contract_path = Path(sys.argv[1])
    else:
        contract_path = Path("/Users/username/Documents/front-middle-schema/.JSON/WEB/payroll/salary-main-screen-block.json")
