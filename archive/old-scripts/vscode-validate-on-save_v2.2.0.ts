#!/usr/bin/env node
/**
 * VSCode On-Save Validator v2.2.0
 *
 ...
 *
 * Usage:
 *   node vscode-validate-on-save_v2.2.0.js path/to/contract.json
 */
...
if (!filePath) {
  ...
  console.error('Usage: node vscode-validate-on-save_v2.2.0.js <file>');
  process.exit(1);
}
...
function formatIssue(
  ...
  console.log(`      -> ${filePath}:${lineNumber}:1`);
  console.log('');
}
