...
Использование:
  node computed_data_parser_v2.2.0.js <contract.json> <data.json> [output.json] [options]
...
Примеры:
  ...
  node computed_data_parser_v2.2.0.js contract.json data.json result.json -v
  node computed_data_parser_v2.2.0.js contract.json data.json result.json --debug
`);
    process.exit(0);
  }
